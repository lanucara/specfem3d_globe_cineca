...
FLAGS_CHECK =  -ftz -assume buffered_io -assume byterecl -align sequence -std03 -diag-disable 6477 -implicitnone -gen-interfaces -warn all -mcmodel=large -shared-intel -O3 -openmp -check nobounds -DFORCE_VECTORIZATION -mmic -qopt-report-phase=vec
...
CC = icc
CFLAGS = -g -O2
CPPFLAGS = -I${SETUP}  -DFORCE_VECTORIZATION -mmic -qopt-report-phase=vec
