        ...
        MODULE COMPUTE_FORCES_CRUST_MANTLE__genmod
          INTERFACE 
            SUBROUTINE COMPUTE_FORCES_CRUST_MANTLE(NSPEC,NGLOB,NSPEC_ATT&
     &,DELTAT,DISPL_CRUST_MANTLE,ACCEL_CRUST_MANTLE,PHASE_IS_INNER,R_XX,&
     ...
     &1)
          ...
          END INTERFACE 
        END MODULE COMPUTE_FORCES_CRUST_MANTLE__genmod
