        ...
        MODULE WRITE_AVS_DX_GLOBAL_FACES_DATA__genmod
          INTERFACE 
            SUBROUTINE WRITE_AVS_DX_GLOBAL_FACES_DATA(MYRANK,PRNAME,    &
     &NSPEC,IMPICUT_XI,IMPICUT_ETA,IBOOL,IDOUBLING,XSTORE,YSTORE,ZSTORE,&
     &NUM_IBOOL_AVS_DX,MASK_IBOOL,NPOINTOT,RHOSTORE,KAPPAVSTORE,MUVSTORE&
     &,NSPL,RSPL,ESPL,ESPL2,ELLIPTICITY,ISOTROPIC_3D_MANTLE,RICB,RCMB,  &
     ...
     &RMIDDLE_CRUST,ROCEAN,IREGION_CODE)
          ...
          END INTERFACE 
        END MODULE WRITE_AVS_DX_GLOBAL_FACES_DATA__genmod
