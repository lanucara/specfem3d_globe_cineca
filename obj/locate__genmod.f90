        ...
        MODULE LOCATE__genmod
          INTERFACE 
            SUBROUTINE LOCATE(X_TARGET,Y_TARGET,Z_TARGET,XI_TARGET,     &
     &ETA_TARGET,GAMMA_TARGET,ISPEC_SELECTED,RANK_SELECTED,NSPEC,NGLOB, &
     &NPROC,IBOOL,XSTORE,YSTORE,ZSTORE,IADDX,IADDY,IADDR,XIGLL,YIGLL,   &
     &ZIGLL,TYPICAL_SIZE,I_SELECTED,J_SELECTED,K_SELECTED)
              ...
              INTEGER(KIND=4), INTENT(OUT) :: ISPEC_SELECTED
              INTEGER(KIND=4), INTENT(OUT) :: RANK_SELECTED
