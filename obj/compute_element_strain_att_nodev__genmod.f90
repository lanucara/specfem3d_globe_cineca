        ...
        MODULE COMPUTE_ELEMENT_STRAIN_ATT_NODEV__genmod
          INTERFACE 
            SUBROUTINE COMPUTE_ELEMENT_STRAIN_ATT_NODEV(ISPEC,NGLOB,    &
     &NSPEC,DISPL,VELOC,DELTAT,IBOOL,HPRIME_XX,HPRIME_YY,HPRIME_ZZ,XIX, &
     &XIY,XIZ,ETAX,ETAY,ETAZ,GAMMAX,GAMMAY,GAMMAZ,                      &
     &EPSILONDEV_XX_LOC_NPLUS1,EPSILONDEV_YY_LOC_NPLUS1,                &
     &EPSILONDEV_XY_LOC_NPLUS1,EPSILONDEV_XZ_LOC_NPLUS1,                &
     &EPSILONDEV_YZ_LOC_NPLUS1,NSPEC_STRAIN_ONLY,                       &
     ...
     &NSPEC_STRAIN_ONLY)
          ...
          END INTERFACE 
        END MODULE COMPUTE_ELEMENT_STRAIN_ATT_NODEV__genmod
