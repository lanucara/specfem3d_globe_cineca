        ...
        MODULE COMPUTE_ELEMENT_TISO__genmod
          INTERFACE 
            SUBROUTINE COMPUTE_ELEMENT_TISO(ISPEC,MINUS_GRAVITY_TABLE,  &
     &DENSITY_TABLE,MINUS_DERIV_GRAVITY_TABLE,RSTORE,DERIV,WGLL_CUBE,   &
     &KAPPAVSTORE,KAPPAHSTORE,MUVSTORE,MUHSTORE,ETA_ANISOSTORE,IBOOL,   &
     &R_XX,R_YY,R_XY,R_XZ,R_YZ,EPSILON_TRACE_OVER_3,ONE_MINUS_SUM_BETA, &
     &VNSPEC,TEMPX1,TEMPX2,TEMPX3,TEMPY1,TEMPY2,TEMPY3,TEMPZ1,TEMPZ2,   &
     &TEMPZ3,DUMMYX_LOC,DUMMYY_LOC,DUMMYZ_LOC,EPSILONDEV_LOC,RHO_S_H)
              ...
              REAL(KIND=4) :: KAPPAHSTORE(5,5,5,11264)
              REAL(KIND=4) :: MUVSTORE(5,5,5,11264)
              REAL(KIND=4) :: MUHSTORE(5,5,5,11264)
              REAL(KIND=4) :: ETA_ANISOSTORE(5,5,5,11264)
          ...
          END INTERFACE 
        END MODULE COMPUTE_ELEMENT_TISO__genmod
