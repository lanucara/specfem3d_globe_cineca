        !COMPILER-GENERATED INTERFACE MODULE: Fri Mar 11 15:46:33 2016
        MODULE WRITE_AVS_DX_GLOBAL_CHUNKS_DATA__genmod
          INTERFACE 
            SUBROUTINE WRITE_AVS_DX_GLOBAL_CHUNKS_DATA(MYRANK,PRNAME,   &
     &NSPEC,IBOUN,IBOOL,IDOUBLING,XSTORE,YSTORE,ZSTORE,NUM_IBOOL_AVS_DX,&
     ...
     &IREGION_CODE)
          ...
          END INTERFACE 
        END MODULE WRITE_AVS_DX_GLOBAL_CHUNKS_DATA__genmod
