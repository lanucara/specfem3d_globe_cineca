...
! parameter module for elastic solver in crust/mantle region
  ...
  real(kind=CUSTOM_REAL), dimension(NGLOB_CRUST_MANTLE) :: &
    xstore_crust_mantle,ystore_crust_mantle,zstore_crust_mantle
      ...
      real(kind=CUSTOM_REAL), dimension(3,NGLOB_CRUST_MANTLE) :: &
    rstore_crust_mantle
...
! parameter module for elastic solver in inner core region
  ...
  real(kind=CUSTOM_REAL), dimension(3,NGLOB_INNER_CORE) :: &
    rstore_inner_core
...
! parameter module for acoustic solver in outer core region
  ...
  real(kind=CUSTOM_REAL), dimension(3,NGLOB_OUTER_CORE) :: &
    rstore_outer_core
